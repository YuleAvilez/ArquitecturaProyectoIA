...
export function registerRepositories() {
  ...
  Container.set(
    ...
    new GenericRepository<SurveyQuestionRequestDto, SurveyQuestions>("surveyQuestion")
  );
  Container.set(
    "VocationalSurveyRepository",
    new GenericRepository<VocationalSurveyRequestDto, VocationalSurveys>("vocationalSurvey")
  );
  Container.set(
    "UserVocationalSurveyRepository",
    new GenericRepository<UserVocationalRequestDto, UserVocationalResponses>("userVocationalResponse")
  );
  Container.set(
    "CareerRecomendationRepository",
    new GenericRepository<CareerRecomendationRequestDto, CareerRecommendations>("careerRecommendation")
  );
  Container.set(
